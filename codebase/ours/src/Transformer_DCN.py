...
class Transformer_DCN(BaseModel):
    ...
    def forward(self, inputs):
        ...
        augru_pooling_emb = self.augru_encoder(seq_transformer_emb, target_emb, mask=mask)  # (b, 16, 256), (B, 256+256)
        ...
        return_dict = {
            ...
            "hidden_state": seq_transformer_emb,  # (B, 16, 256)
            "mask": mask,  # (B, 16)
            }
